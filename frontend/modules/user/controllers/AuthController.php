...
class AuthController extends \yii\web\Controller
{
    ...
    public function actionAuthSuccess($client)
    {
        ...
        return $this->redirect(['/pub/dashboard']);
...
//        return $this->goHome();
    ...
    {
        return \common\models\EmailQueue::queue('mailer_marketing', $user->email, 'New password', $this->module->id, 'send_new_password', ['fullname' => $user->fullname, 'user_id' => $user->user_id, 'password' => $password],null);
    }
    ...
    {
        return \common\models\EmailQueue::queue('mailer_marketing', $user->email, 'Confirm reset password', $this->module->id, 'forgot_password', ['fullname' => $user->fullname, 'confirm_key' => $confirmKey],null);
    }
